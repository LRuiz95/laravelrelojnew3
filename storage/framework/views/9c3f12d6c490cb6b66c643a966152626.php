...
<div class="container-fluid px-4">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
        <div>
            <nav aria-label="breadcrumb"><ol class="breadcrumb small mb-1"><li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>">Inicio</a></li><li class="breadcrumb-item active">Firebird</li></ol></nav>
            <h1 class="h3 mb-1">Sincronización Firebird</h1>
            <p class="text-muted small mb-0">Legacy → MySQL · Selecciona solo lo que necesitas</p>
        </div>
                    ...
                    <div class="card-body p-0">
                        ...
                        <?php else: ?>
                            <?php $__currentLoopData = $syncs->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sync): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                    $sc = match($sync->status) { 'completed'=>'success', 'failed'=>'danger', 'running'=>'primary', default=>'secondary' };
                                ?>
                                <a href="<?php echo e(route('firebird.sync', $sync)); ?>" class="d-flex align-items-center gap-2 px-3 py-2 text-decoration-none border-bottom" style="border-color:var(--border)!important">
                                    <span class="badge bg-<?php echo e($sc); ?> badge-pill" style="font-size:8px">&nbsp;</span>
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $syncs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sync): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php $sc = match($sync->status) { 'completed'=>'success', 'failed'=>'danger', 'running'=>'primary', 'cancelled'=>'warning', default=>'secondary' }; ?>
                                <tr>
                                    <td style="font-family:'JetBrains Mono',monospace">#<?php echo e($sync->id); ?></td>
                                    <td><span class="badge bg-secondary"><?php echo e($sync->operationLabel); ?></span></td>
                                    <td><?php echo e($sync->ciclo ?? '-'); ?></td>
                                    <td><span class="badge bg-<?php echo e($sc); ?>"><?php echo e($sync->statusLabel); ?></span></td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravelrelojnew\resources\views/firebird/index.blade.php ENDPATH**/ ?>