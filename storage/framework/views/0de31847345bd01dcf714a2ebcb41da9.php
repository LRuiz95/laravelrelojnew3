...
unset($__errorArgs, $__bag); ?>" id="name" name="name"
                       value="<?php echo e(old('name', $device->name)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="ip" name="ip"
                       value="<?php echo e(old('ip', $device->ip ?? env('ZKTECO_DEFAULT_IP'))); ?>" required>
                <div class="form-text">Valor actual: <?php echo e($device->ip ?? env('ZKTECO_DEFAULT_IP', 'No configurado')); ?></div>
                <?php $__errorArgs = ['ip'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" id="port" name="port"
                           value="<?php echo e(old('port', $device->port)); ?>" required>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravelrelojnew\resources\views\devices\edit.blade.php ENDPATH**/ ?>